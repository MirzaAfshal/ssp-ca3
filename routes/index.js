...
router.put('/modifyrecord/:tag/:fileinfo', async (req, res) =>{
  ...
  if(req.params.tag === "delete"){
    await DeleteData(data,FileName.trim(),AutoGeneratedString.trim(),FilePassword.trim())
  }
  else{
    await UpdateData(data,FileName.trim(),AutoGeneratedString.trim(),FilePassword.trim())
  }
})
